...
- [x] **Secure Authentication (CLI)**
    ...
    - **Status:** Implemented cross-platform keyring support with Windows persistence fix.
...
- [x] **Search & Discovery Polish**
    ...
    - **Status:** Implemented server-side sorting and homepage sections for Latest/Top packages.
...
- [x] **The "Mosaic Book" (Documentation Site)**
    ...
    - **Status:** Implemented Nextra docs in `/docs` using App Router.
...
- [x] **One-Line Install Script**
    ...
    - **Status:** Scripts created in `website/public` and integrated into homepage.
...
- [x] **Legal & Social**
    ...
    - **Status:** Added Terms and Privacy MDX pages; integrated social links in global footer.
